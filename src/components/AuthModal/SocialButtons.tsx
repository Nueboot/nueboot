...
export const FacebookButton: React.SFC<{}> = props => {
  const style: React.CSSProperties = {
    backgroundColor: '#3B5998',
  };

  return (
    <Button style={style} className="flex items-center white bn">
      <svg className="w1 h1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="1.414"><path d="M15.117 0H.883C.395 0 0 .395 0 .883v14.234c0 .488.395.883.883.883h7.663V9.804H6.46V7.39h2.086V5.607c0-2.066 1.262-3.19 3.106-3.19.883 0 1.642.064 1.863.094v2.16h-1.28c-1 0-1.195.476-1.195 1.176v1.54h2.39l-.31 2.416h-2.08V16h4.077c.488 0 .883-.395.883-.883V.883C16 .395 15.605 0 15.117 0" fillRule="nonzero"/></svg>
      <Text className="f6 ml3 pr2 white">Login with Facebook</Text>
    </Button>
  );
};

export const GoogleButton: React.SFC<{}> = props => {

  return (
    <Button className="flex items-center white ba">
      <svg className="w1 h1" viewBox="0 0 118 120" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
